...
private val VERIFIED_GLOBAL_DONUK_CLAIMS = listOf(
...
data class SalesOpportunity(
    ...
    val verifiedClaims: List<String> = VERIFIED_GLOBAL_DONUK_CLAIMS,
 ...
 *
 * Company claims shown in the UI are sourced from the current Global Donuk Gıda
 * public website and are not treated as business-specific facts.
 */
